...
public abstract class Paths
{
    ...
    internal static class WarfrontCampaign
    {
        ...
        public const string ClaimToolsPath = Menus + "/WorldMap/submenus/warfrontCampaignSubmenu/loot";

        public const string ClaimToolsButton = ClaimToolsPath + "/claimButton";

        public const string NextLootTimeLeft = ClaimToolsPath + "/nextLootTimeLeft";
    }
